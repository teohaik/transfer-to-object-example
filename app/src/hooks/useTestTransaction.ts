...
export const useTestTransaction = () => {
  ...
  const handleExecute = () => {
    ...
    const nft = tx.moveCall({
      target: "0xeefeb7429cb5e2772762a872a1f0089e711e7ad8330808cb08db49e1d5754537::dummy_nft1::mint",
      arguments: [tx.pure.string(`Test NFT ${Math.floor(Math.random() * 10_000)}`)],
    });
